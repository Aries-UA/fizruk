...
<div class="page left">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                ...
                <td class="quantity">
                    <input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" class="checkout_qty" />
                    <input type="image" src="catalog/view/theme/fizruk/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
                    <a href="<?php echo $product['remove']; ?>">
                        <img src="catalog/view/theme/fizruk/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" />
                    </a>
                </td>
                <td class="price">
    ...
    <?php if ($coupon_status || $voucher_status || $reward_status || $shipping_status) { ?>
        ...
        <div class="content">
            <p style="width: 580px;"><?php echo $text_next_choice; ?></p>
            <table class="radio">
    ...
    <table id="total" class="total right" style="width: 0;">
