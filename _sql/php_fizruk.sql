...
--
-- Хост: localhost
-- Время создания: Окт 08 2012 г., 22:30
...
(4, 'Гривня', 'uah', '', 'грн', '2', 1.00000000, 1, '2012-10-08 20:52:38');
...
(490, 0, 'config', 'config_seo_url', 0x30, 0),
(489, 0, 'config', 'config_use_ssl', 0x30, 0),
(491, 0, 'config', 'config_maintenance', 0x30, 0),
(487, 0, 'config', 'config_fraud_score', '', 0),
(488, 0, 'config', 'config_fraud_status_id', 0x37, 0),
(486, 0, 'config', 'config_fraud_key', '', 0),
(27, 0, 'coupon', 'coupon_sort_order', 0x34, 0),
(28, 0, 'coupon', 'coupon_status', 0x31, 0),
(485, 0, 'config', 'config_fraud_detection', 0x30, 0),
(484, 0, 'config', 'config_alert_emails', '', 0),
(483, 0, 'config', 'config_account_mail', 0x30, 0),
...
(482, 0, 'config', 'config_alert_mail', 0x30, 0),
(480, 0, 'config', 'config_smtp_port', 0x3235, 0),
(481, 0, 'config', 'config_smtp_timeout', 0x35, 0),
...
(475, 0, 'config', 'config_mail_protocol', 0x6d61696c, 0),
(53, 0, 'reward', 'reward_sort_order', 0x32, 0),
(54, 0, 'reward', 'reward_status', 0x31, 0),
(474, 0, 'config', 'config_image_cart_height', 0x3738, 0),
...
(473, 0, 'config', 'config_image_cart_width', 0x3738, 0),
(472, 0, 'config', 'config_image_wishlist_height', 0x3738, 0),
...
(471, 0, 'config', 'config_image_wishlist_width', 0x3738, 0),
(470, 0, 'config', 'config_image_compare_height', 0x3738, 0),
(468, 0, 'config', 'config_image_related_height', 0x313239, 0),
(469, 0, 'config', 'config_image_compare_width', 0x3738, 0),
(467, 0, 'config', 'config_image_related_width', 0x313535, 0),
(465, 0, 'config', 'config_image_additional_width', 0x313535, 0),
(466, 0, 'config', 'config_image_additional_height', 0x313239, 0),
(464, 0, 'config', 'config_image_product_height', 0x313239, 0),
(463, 0, 'config', 'config_image_product_width', 0x313535, 0),
(462, 0, 'config', 'config_image_popup_height', 0x353030, 0),
(460, 0, 'config', 'config_image_thumb_height', 0x323330, 0),
(458, 0, 'config', 'config_image_category_height', 0x313239, 0),
(461, 0, 'config', 'config_image_popup_width', 0x353030, 0),
(459, 0, 'config', 'config_image_thumb_width', 0x323535, 0),
(457, 0, 'config', 'config_image_category_width', 0x313535, 0),
(455, 0, 'config', 'config_logo', 0x646174612f6c6f676f2e706e67, 0),
(456, 0, 'config', 'config_icon', 0x646174612f636172742e706e67, 0),
(454, 0, 'config', 'config_return_status_id', 0x32, 0),
(453, 0, 'config', 'config_commission', 0x35, 0),
(452, 0, 'config', 'config_affiliate_id', 0x34, 0),
(451, 0, 'config', 'config_stock_status_id', 0x35, 0),
(93, 0, 'voucher', 'voucher_sort_order', 0x38, 0),
(94, 0, 'voucher', 'voucher_status', 0x31, 0),
(450, 0, 'config', 'config_stock_checkout', 0x30, 0),
(448, 0, 'config', 'config_stock_display', 0x30, 0),
(449, 0, 'config', 'config_stock_warning', 0x30, 0),
(446, 0, 'config', 'config_order_status_id', 0x31, 0),
(102, 0, 'free_checkout', 'free_checkout_status', 0x31, 0),
(103, 0, 'free_checkout', 'free_checkout_order_status_id', 0x31, 0),
(447, 0, 'config', 'config_complete_status_id', 0x35, 0),
(445, 0, 'config', 'config_invoice_prefix', 0x494e562d323031322d3030, 0),
...
(444, 0, 'config', 'config_order_edit', 0x313030, 0),
(443, 0, 'config', 'config_checkout_id', 0x35, 0),
(442, 0, 'config', 'config_guest_checkout', 0x31, 0),
(441, 0, 'config', 'config_cart_weight', 0x31, 0),
(440, 0, 'config', 'config_account_id', 0x33, 0),
(439, 0, 'config', 'config_customer_price', 0x30, 0),
(437, 0, 'config', 'config_customer_group_id', 0x31, 0),
(438, 0, 'config', 'config_customer_group_display', 0x613a313a7b693a303b733a313a2231223b7d, 1),
(436, 0, 'config', 'config_customer_online', 0x30, 0),
(435, 0, 'config', 'config_tax_customer', 0x7368697070696e67, 0),
(433, 0, 'config', 'config_vat', 0x30, 0),
(434, 0, 'config', 'config_tax_default', 0x7368697070696e67, 0),
(432, 0, 'config', 'config_tax', 0x31, 0),
(431, 0, 'config', 'config_voucher_max', 0x31303030, 0),
(430, 0, 'config', 'config_voucher_min', 0x31, 0),
(429, 0, 'config', 'config_upload_allowed', 0x6a70672c204a50472c206a7065672c206769662c20706e672c20747874, 0),
(428, 0, 'config', 'config_download', 0x30, 0),
(427, 0, 'config', 'config_review_status', 0x31, 0),
(426, 0, 'config', 'config_product_count', 0x30, 0),
(425, 0, 'config', 'config_admin_limit', 0x3230, 0),
(424, 0, 'config', 'config_catalog_limit', 0x36, 0),
(423, 0, 'config', 'config_weight_class_id', 0x31, 0),
(422, 0, 'config', 'config_length_class_id', 0x31, 0),
(421, 0, 'config', 'config_currency_auto', 0x31, 0),
(420, 0, 'config', 'config_currency', 0x756168, 0),
(419, 0, 'config', 'config_admin_language', 0x7275, 0),
(418, 0, 'config', 'config_language', 0x7275, 0),
(417, 0, 'config', 'config_zone_id', 0x33343930, 0),
(414, 0, 'config', 'config_template', 0x66697a72756b, 0),
(415, 0, 'config', 'config_layout_id', 0x34, 0),
(416, 0, 'config', 'config_country_id', 0x323230, 0),
(413, 0, 'config', 'config_meta_description', 0xd184d0b8d0b7d180d183d0ba, 0),
(411, 0, 'config', 'config_fax', '', 0),
(412, 0, 'config', 'config_title', 0xd0a4d0b8d0b7d180d183d0ba, 0),
(410, 0, 'config', 'config_telephone', 0x313233343536373839, 0),
(409, 0, 'config', 'config_email', 0x61726965732e666f72756d40676d61696c2e636f6d, 0),
(408, 0, 'config', 'config_address', 0xd0b32e20d09ad0b8d0b5d0b2, 0),
(407, 0, 'config', 'config_owner', 0xd0a5d0bed0b4d0bed0b1d0b0d18820d0a0d0bed0bcd0b0d0bd, 0),
(406, 0, 'config', 'config_name', 0xd0a4d0b8d0b7d180d183d0ba, 0),
(492, 0, 'config', 'config_encryption', 0x6163646132653666356130623235636239333663653764363239643463643166, 0),
(493, 0, 'config', 'config_compression', 0x30, 0),
(494, 0, 'config', 'config_error_display', 0x31, 0),
(495, 0, 'config', 'config_error_log', 0x31, 0),
(496, 0, 'config', 'config_error_filename', 0x6572726f722e747874, 0),
(497, 0, 'config', 'config_google_analytics', '', 0);
